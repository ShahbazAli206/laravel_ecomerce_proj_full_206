      ...
      <div class="col-12">
          <div class="card">
              <div class="card-header">
                  <h5>Edit pProducts</h5>
              </div>
              <div class="card-body">
                  <form action="{{route('adminpanel.products.edit', $asdf->id)}}" method="post" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                      <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="price" id="price" class="form-control @error('price') is_invalid @enderror" value="{{$asdf->price / 100}}">
                                @error('price')
                                <span class="invalid-feedback">
                                    <strong>{{$message}}</strong> 
                                </span>
                       ...
                       <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" id="description" cols="30" rows="10" class="form-control @error('description') is_invalid @enderror" placeholder="Describe Your Products ........">{{$asdf->description}}</textarea>
                                @error('description')
                                    <span class="invalid-feedback">
                                        <strong>{{$message}}</strong>
                                    </span>                                   
